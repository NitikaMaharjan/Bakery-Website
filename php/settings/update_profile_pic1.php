...
<html>
    ...
    <body>
        <div class="page">
            ...
            <div class="contents">
                <div class="three">
                    <h1>Settings - Update Profile Picture</h1>
                    <div class="top-right">
                ...
                <div class="settingsinfo">
                    ...
                    <form action="/LocalBakehouse/php/settings/update_profile_pic.php" method="POST" enctype="multipart/form-data">
                        <div id="form-line">
                            <label for="a_profile_pic">Profile Picture:</label>
                            <input type="file" name="a_profile_pic" accept="image/*" required/>
                        </div>
                        <input type="submit" value="Update Profile Picture" style="margin-left: 300px;"/>
                    </form>
                </div>
            </div>
        </div>
