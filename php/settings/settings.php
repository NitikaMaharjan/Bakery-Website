...
<html>
    ...
    <body>
        <div class="page">
            ...
            <div class="contents">
                ...
                <div class="settingsinfo1">
                    <h3>Settings</h3>
                    <button onclick="window.location.href='/LocalBakehouse/php/settings/update_profile_pic1.php'">Update Profile Picture</button><br/>
                    <button onclick="delete_profile_pic()">Delete Profile Picture</button><br/>
                    <button onclick="window.location.href='/LocalBakehouse/php/settings/change_password1.php'">Change Password</button><br/>
                </div>
            </div>
        </div>
    </body>
    <script>
        ...
        function delete_profile_pic() {
            var ans = confirm("Are you sure you want to delete your profile picture?");
            if (ans == true) {
                window.location.href = "/LocalBakehouse/php/settings/delete_profile_pic.php";
            }
        }
    </script>
</html>
