        ...
        <div class="page">
            ...
            <div class="contents">
                ...
                <div class="bakeryinfo">
                    ...
                    <form method="POST" action="/LocalBakehouse/php/bakery_info/add_bakery_info.php" enctype="multipart/form-data">
                        <div id="form-line">
                        ...
                        <div id="form-line">
                            ...
                            <input type="file" name="b_logo" accept="image/*" style="width:auto;" required/>
                        </div>
            
                        <div id="form-line">
                            <label for="b_description">Bakery Description:</label>
                            <textarea name="b_description" id="b_description" required></textarea>
                        </div>
            
                        <div id="form-line">
                            <label for="b_address">Bakery Address:</label>
                            <input type="text" name="b_address" id="b_address" required/>
                        </div>
            
                        <div id="form-line">
                            <label for="b_contact_number">Bakery Contact Number:</label>
                            <input type="text" name="b_contact_number" id="b_contact_number" required/>
                        </div>
            
                        <div id="form-line">
                            <label for="b_email">Bakery Email:</label>
                            <input type="email" name="b_email" id="b_email" required/>
                        </div>

                        <input type="submit" value="Add Bakery Info" style="margin-left: 857px;"/>
                    </form>
                </div>
            </div>
        </div>
